...
#line 72 "MachineIndependent/glslang.y"
    ...
    struct {
        ...
        glslangA::TSymbol* symbol;
    } lex;
    struct {
        glslangA::TSourceLoc loc;
        glslangA::TOperator op;
        union {
            TIntermNode* intermNode;
            glslangA::TIntermNodePair nodePair;
            glslangA::TIntermTyped* intermTypedNode;
            glslangA::TAttributes* attributes;
            glslangA::TSpirvRequirement* spirvReq;
            glslangA::TSpirvInstruction* spirvInst;
            glslangA::TSpirvTypeParameters* spirvTypeParams;
        };
        union {
            glslangA::TPublicType type;
            glslangA::TFunction* function;
            glslangA::TParameter param;
            glslangA::TTypeLoc typeLine;
            glslangA::TTypeList* typeList;
            glslangA::TArraySizes* arraySizes;
            glslangA::TIdentifierList* identifierList;
        };
        glslangA::TTypeParameters* typeParameters;
    } interm;
...
int yyparse (glslangA::TParseContext* pParseContext);
